/*
PS : bounding condition on permutation problem
Where 2 consequative letters should not be there. ex AB should not be their
In a same alphabetic order
TC = n!
SC = n
*/
...
void perm(int k){
    ...
    for(int i = 0; i < n; i++){
        if(sel[i] == false){    
            ...
            //here i will check that bounding condition
